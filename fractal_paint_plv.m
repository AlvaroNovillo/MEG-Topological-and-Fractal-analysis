...
Cm_boys = load(sprintf("Cm_new/%s/Cm_boys.mat",band));
Cm_girls = load(sprintf("Cm_new/%s/Cm_girls.mat",band));

Cm_null_boys = load(sprintf("Cm_new/%s/Cm_boys.mat",band));
Cm_null_girls = load(sprintf("Cm_new/%s/Cm_girls.mat",band));
