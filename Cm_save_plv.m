...
%     %Random Walker
    ...
    N = 10*numnodes(GCC_boys); %Length of the RW
    walk = rand_walk(adGCC_boys,N,n_0); %Random Walker initiation
    tic
    Cm = EmbDim(8,N,walk,X,Y); %Computes the Corr. Sum 
    toc
    Cm_boys(:,:,i) = Cm;
end
save('Cm\Cm_boys.mat',"Cm_boys");
...
%     %Random Walker
    ...
    N = 10*numnodes(GCC_girls); %Length of the RW
